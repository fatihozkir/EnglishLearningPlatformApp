...
{
    [DbContext(typeof(EnglishLearningPlatformAppDbContext))]
    [Migration("20260712233257_AddContentQuestions")]
    partial class AddContentQuestions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EnglishLearningPlatformApp.Authors.Author", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("EnglishLearningPlatformApp.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EnglishLearningPlatformApp.Content.ContentItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppContentItems", (string)null);
                });

            modelBuilder.Entity("EnglishLearningPlatformApp.Content.ContentQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("AnswerDefinitionJson")
                        .IsRequired()
                        .HasMaxLength(20000)
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("ContentSectionId", "Position");

                    b.HasIndex("TenantId", "ContentSectionId");

                    b.ToTable("AppContentQuestions", (string)null);
                });

            modelBuilder.Entity("EnglishLearningPlatformApp.Content.ContentQuestionOption", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("ContentQuestionId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ContentQuestionId", "Position");

                    b.HasIndex("TenantId", "ContentQuestionId");

                    b.ToTable("AppContentQuestionOptions", (string)null);
                });

            modelBuilder.Entity("EnglishLearningPlatformApp.Content.ContentSection", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ContentVersionId", "Position");

                    b.HasIndex("TenantId", "ContentVersionId");

                    b.ToTable("AppContentSections", (string)null);
                });

            modelBuilder.Entity("EnglishLearningPlatformApp.Content.ContentVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppContentVersions", (string)null);
                });
            ...
            modelBuilder.Entity("EnglishLearningPlatformApp.Books.Book", b =>
                {
                    b.HasOne("EnglishLearningPlatformApp.Authors.Author", null)
                        .WithMany()
            ...
            modelBuilder.Entity("EnglishLearningPlatformApp.Content.ContentQuestion", b =>
                {
                    b.HasOne("EnglishLearningPlatformApp.Content.ContentSection", null)
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("EnglishLearningPlatformApp.Content.ContentQuestionOption", b =>
                {
                    b.HasOne("EnglishLearningPlatformApp.Content.ContentQuestion", null)
                        .WithMany("Options")
                        .HasForeignKey("ContentQuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("EnglishLearningPlatformApp.Content.ContentSection", b =>
                {
                    b.HasOne("EnglishLearningPlatformApp.Content.ContentVersion", null)
                        .WithMany("Sections")
            ...
            modelBuilder.Entity("EnglishLearningPlatformApp.Content.ContentVersion", b =>
                {
                    b.HasOne("EnglishLearningPlatformApp.Content.ContentItem", null)
                        .WithMany("Versions")
