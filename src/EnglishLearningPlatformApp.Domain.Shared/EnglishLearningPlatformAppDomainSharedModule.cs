...
public class EnglishLearningPlatformAppDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        EnglishLearningPlatformAppGlobalFeatureConfigurator.Configure();
        EnglishLearningPlatformAppModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<EnglishLearningPlatformAppDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<EnglishLearningPlatformAppResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/EnglishLearningPlatformApp");

            options.DefaultResourceType = typeof(EnglishLearningPlatformAppResource);
        ...
        {
            options.MapCodeNamespace("EnglishLearningPlatformApp", typeof(EnglishLearningPlatformAppResource));
        });
    }
}
